...
exec_kinit() {
	...
	if [ ! -f $KINIT_PW_FILE ];then
		echo -ne "${red}Password for `whoami`@ncon2.nhnsystem.com:${reset}"
		read -s -e password
	else 
...
print_host_list() {
	...
	for (( i= $begin_index; i <= $last_index; i++ ));do
		...
		if [ "$selected_host" == "$host" ];then
			printmsg=${printmsg/ -/>>}
			printmsg=${bg_green}${black}$printmsg${reset}${bg_reset}
		else
...
echo ""
echo ""
echo -e "   SSSSSSSSSSSSSSS   iiii                   WWWWWWWW                           WWWWWWWW                                  "   
echo -e " SS:::::::::::::::S i::::i                  W::::::W                           W::::::W                                  "
echo -e "S:::::SSSSSS::::::S  iiii                   W::::::W                           W::::::W                                  "
echo -e "S:::::S     SSSSSSS                         W::::::W                           W::::::W                                  "
echo -e "S:::::S            iiiiiii                   W:::::W           WWWWW           W:::::W    ooooooooooo      ooooooooooo   "
echo -e "S:::::S            i:::::i                    W:::::W         W:::::W         W:::::W   oo:::::::::::oo  oo:::::::::::oo "
echo -e " S::::SSSS          i::::i                     W:::::W       W:::::::W       W:::::W   o:::::::::::::::oo:::::::::::::::o"
echo -e "  SS::::::SSSSS     i::::i  ---------------     W:::::W     W:::::::::W     W:::::W    o:::::ooooo:::::oo:::::ooooo:::::o"
echo -e "    SSS::::::::SS   i::::i  -:::::::::::::-      W:::::W   W:::::W:::::W   W:::::W     o::::o     o::::oo::::o     o::::o"
echo -e "       SSSSSS::::S  i::::i  ---------------       W:::::W W:::::W W:::::W W:::::W      o::::o     o::::oo::::o     o::::o"
echo -e "            S:::::S i::::i                         W:::::W:::::W   W:::::W:::::W       o::::o     o::::oo::::o     o::::o"
echo -e "            S:::::S i::::i                          W:::::::::W     W:::::::::W        o::::o     o::::oo::::o     o::::o"
echo -e "SSSSSSS     S:::::Si::::::i                          W:::::::W       W:::::::W         o:::::ooooo:::::oo:::::ooooo:::::o"
echo -e "S::::::SSSSSS:::::Si::::::i                           W:::::W         W:::::W          o:::::::::::::::oo:::::::::::::::o"
echo -e "S:::::::::::::::SS i::::::i                            W:::W           W:::W            oo:::::::::::oo  oo:::::::::::oo "
echo -e " SSSSSSSSSSSSSSS   iiiiiiii                             WWW             WWW               ooooooooooo      ooooooooooo   "
echo ""
echo ""
echo ""
echo -en "${reset}"
...
print_command() {
	local command
	command="${command}${magenta}`whoami`@ncon2.nhnsystem.com> ${reset}"
...
do_execute() {
	...
	echo -e "${red}Hello SIWOO ${yellow}$hostname_filter${reset} as ${magenta}$user${reset} ..."
	echo 
...
good_bye(){
	...
	tput cud1
	tput ed
	echo -e "${reset}${red}GoodBye SIWOO!${reset}"
	echo 
	stty echo 
	exit 0;
}
